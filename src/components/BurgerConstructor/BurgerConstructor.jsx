    ...
    return (
        <section className={`${styles.container} pt-25`}>
            <div className={styles.listWithBuns}>
                <div style={{marginRight: "16px"}}><ConstructorElement
                    type="top"
                    isLocked={true}
                ...
                <ul className={styles.stuffing}>
                    {dummyData
                        .map((item, index) => <BurgerConstructorListItem key={index} text={item.text} price={item.price} thumbnail={item.thumbnail} />)}
                </ul>
                <div style={{marginRight: "16px"}}><ConstructorElement
                    type="bottom"
                    isLocked={true}
