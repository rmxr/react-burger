...
export const FEED_CONNECTION_END: 'FEED_CONNECTION_END' = 'FEED_CONNECTION_END';

export const ORDERS_CONNECTION_START: 'ORDERS_CONNECTION_START' = 'ORDERS_CONNECTION_START';
export const ORDERS_CONNECTION_END: 'ORDERS_CONNECTION_END' = 'ORDERS_CONNECTION_END';
